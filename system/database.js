module.exports = (m) => {
  ...
  if (setting) {
    ...
    global.db.setting = {
      ...
      online: true,
      onlyprefix: '+',
      owners: ['6285238543351', '6283192887162'],
      lastReset: new Date() * 1,
      msg: 'Hi +tag 🪸\nI am an automated system (WhatsApp Bot) that can help to do something, search and get data / information only through WhatsApp.\n\n◦ *Database* : +db\n◦ *Library* : Baileys v+version\n',
      menuStyle: 4,
      cover: 'https://thesocialmediamonthly.com/wp-content/uploads/2019/04/BOT-banner.jpg',
      link: 'https://chat.whatsapp.com/ImbG1XNo6yx1gIMspR1gWO',
    };
  }
};
